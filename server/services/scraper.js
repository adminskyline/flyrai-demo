...
export async function scrapeListingUrl(url, apiKey, provider) {
  // Fetch the listing page HTML with browser-like headers
  ...
  if (!res.ok) {
    if (res.status === 403) {
      throw new Error("This site blocked our request (403). Enter the property details manually or upload photos below.");
    }
